...
- [Logdissect](https://github.com/dogoncouch/logdissect/) - A CLI utility and Python API for analyzing log files and other data. ([MIT](https://github.com/dogoncouch/logdissect/blob/master/LICENSE))
